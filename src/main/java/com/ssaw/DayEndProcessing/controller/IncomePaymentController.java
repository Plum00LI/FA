...
//        System.out.println("i="+i);
    ...
    public int statisticSecurties(String Securities){
...
//            String accoundId=dbUtil.requestDbTableMaxId(SysTableNameListUtil.A);
...
//            securitiesClosedPay.setAccountId(accoundId);
...
//            //4调用bankTreasurer的 set方法获得现金账户Id
//            bankTreasurer.setAccountId(accoundId);
//            //5调用bankTreasurer的 set方法获得调拨方向flag
