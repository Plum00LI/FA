...
public class ClosingDate {
    ...
    public ClosingDate(String securitiesId, String securitiesName, Double num, Double price, Double commission, Double stamp, Double brokerage, Double transfer, Double management, Double security, Double totalSum, int transactionDataMode, int securitiesType) {
