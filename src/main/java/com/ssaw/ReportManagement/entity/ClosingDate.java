...
public class ClosingDate {
    ...
    public ClosingDate(String transactionDataId, String accountName, String securitiesName, Double price, Double num, Double netReceipts, Double totalSum, int transactionDataMode, String dateTime, String settlementDate, int status, String fundId, String fundName, String securitiesId, String brokersId, String brokersName, String seateId, String seateName, String accountId, String blankName, int flag, Double commission, Double transfer, Double brokerage, Double stamp, Double management, Double security,int securitiesType, String transactionDataDesc) {
